...
@section('content')
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ url('toko_bumiayu/barangKeluarbumiayu') }}";
        form.submit();
     }
    </script>
...
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'bk') {
            window.location.href = "{{ url('toko_bumiayu/barangKeluarRincibumiayu') }}";
...
<script>
    ...
    form.action = "{{ url('toko_bumiayu/printLaporanBKbumiayu') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_bumiayu/printExcelBkbumiayu') }}";
    form.target = "_blank";
    form.submit();
}
</script>
