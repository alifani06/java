...
@section('content')
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ route('barangOperbumiayu') }}";
            form.submit();  
        }
    </script>
...
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'masuk') {
            window.location.href = "{{ route('barangOperanbumiayuMasuk') }}";
        } else if (selectedValue === 'keluar') {
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_bumiayu/printLaporanBObumiayu') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_bumiayu/printExcelBobumiayu') }}";
    form.target = "_blank";
    form.submit();
}
</script>
