...
@section('content')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ route('barangMasuksemuabumiayu') }}";
            form.submit();
        }
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_bumiayu/printLaporanBmsemuabumiayu') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'permintaan') {
            ...
            window.location.href = "{{ route('barangMasukpesananbumiayu') }}"; 
        }else if (selectedValue === 'semua') {
            window.location.href = "{{ route('barangMasuksemuabumiayu') }}"; 
        }
    });
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_bumiayu/printExcelBmsemuabumiayu') }}";
    form.target = "_blank";
    form.submit();
}
</script>
