...
<body>
    <div class="container">
        ...
        <!-- Judul Surat -->
        <div class="change-header">SURAT PENGIRIMAN BARANG JADI - PEMESANAN</div>
        ...
        <div>
            <p style="margin-bottom: 2px;">
                ...
                <span style="min-width: 50px; display: inline-flex; align-items: center;">: {{ $pengirimanBarangJadi->first()->kode_pengirimanpesanan }}</span>
            </p>
            <p style="margin-bottom: 2px;">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="{{ url('toko_bumiayu/pengirimanpemesanan_tokobumiayu') }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> Kembali
                </a>
            </div>
            <div>
                <a href="{{ route('pengirimanpemesanan_tokobumiayu.print', $pengirimanBarangJadi->first()->id) }}" id="printButton" target="_blank" class="btn btn-primary btn-sm">
