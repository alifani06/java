                            ...
                            @foreach ($inquery as $permintaan)
                                <tr class="permintaan-header" data-permintaan-id="{{ $permintaan->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('toko_bumiayu/permintaan_produk/' . $permintaan->id) }}" class="btn btn-info btn-sm">
...
<script>
    ...
    form.action = "{{ url('toko_bumiayu/printReportRinci') }}";
    form.target = "_blank";
    form.submit();
}
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'global') {
            window.location.href = "{{ url('toko_bumiayu/laporan_permintaanproduk') }}";
