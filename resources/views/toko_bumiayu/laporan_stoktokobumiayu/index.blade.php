            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Data Stok Toko </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
...
<script>
    ...
    form.action = "{{ url('toko_bumiayu/printstoktokobumiayu') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
...
<script>
    function printExcel() {
        if (event) event.preventDefault();
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_bumiayu/printexcelstoktokobumiayu') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
