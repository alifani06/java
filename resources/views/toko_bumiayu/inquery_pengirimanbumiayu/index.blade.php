                    ...
                    <table id="datatables66" class="table table-bordered" style="font-size: 13px">
                        ...
                        <tbody>
                            @foreach ($stokBarangJadi as $kodePengiriman => $stokItems)
                                ...
                                @endphp
                                <tr class="dropdown" data-id="{{ $firstItem->id }}">
                                    <td class="text-center">{{ $loop->iteration }}</td>
                                    <td>{{ $kodePengiriman }}</td>
                                    <td>{{ \Carbon\Carbon::parse($tanggalPengiriman)->format('d/m/Y H:i') }}</td>
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($status == 'unpost')
                                                ...
                                                <a class="dropdown-item" href="{{ url('toko_bumiayu/inquery_pengirimanbarangjadi/' . $firstItem->id . '/edit') }}">Update</a>
                                                <a class="dropdown-item" href="{{ url('/toko_bumiayu/inquery_pengirimanbarangjadi/' . $firstItem->id) }}">Show</a>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_bumiayu/pengiriman_tokoslawi/unpost_pengiriman/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_bumiayu/pengiriman_tokoslawi/posting_pengiriman/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
