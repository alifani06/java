...
<hr style="margin-bottom: 2px; margin-top: 2px;">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ url('toko_bumiayu/pemesanan_produk') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Kembali
                    </a>
                </div>
                <div>
                    <a href="{{ route('toko_bumiayu.pemesanan_produk.cetak-pdf', $pemesanan->id) }}" target="_blank" class="btn btn-primary btn-sm">
