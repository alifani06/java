...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="{{ url('toko_banjaran/inquery_returbanjaran') }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> Kembali
                </a>
            </div>
            <div>
                <a href="{{ route('inquery_returbanjaran.print', $pengirimanBarangJadi->first()->id) }}" id="printButton" target="_blank" class="btn btn-primary btn-sm">
