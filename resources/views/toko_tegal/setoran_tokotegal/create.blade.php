...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Setoran Penjualan Tegal</h1>
                </div><!-- /.col -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <select class="custom-select form-control" id="toko" name="toko_id" readonly>
                                    <option value="2" selected>TEGAL</option>
                                </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.penjualantoko.kotortgl') }}" 
                            id="penjualan_kotor_link_modal" 
                            class="btn btn-primary" 
                            target="_blank">Barang Keluar</a>

                            <a href="{{ route('print.fakturpenjualantokotgl') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositkeluartokotgl') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositmasuktokotgl') }}" 
        ...
        <div class="modal fade" id="penjualanMesinedcModal" tabindex="-1" role="dialog" aria-labelledby="penjualanMesinedcModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanmesinedctgl') }}" 
                            id="penjualan_mesinedc_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananmesinedctgl') }}" 
        ...
        <div class="modal fade" id="penjualanQrisModal" tabindex="-1" role="dialog" aria-labelledby="penjualanQrisModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanqristgl') }}" 
                            id="penjualan_qris_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananqristgl') }}" 
        ...
        <div class="modal fade" id="penjualanTransferModal" tabindex="-1" role="dialog" aria-labelledby="penjualanTransferModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualantransfertgl') }}" 
                            id="penjualan_transfer_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanantransfertgl') }}" 
        ...
        <div class="modal fade" id="penjualanGobizModal" tabindex="-1" role="dialog" aria-labelledby="penjualanGobizModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualangobiztgl') }}" 
                            id="penjualan_gobiz_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanangobiztgl') }}" 
    ...
    <script>
        ...
        function updateModalLink() {
            ...
            const baseUrlBarangKeluar = "{{ route('print.penjualantoko.kotortgl') }}";
            const baseUrlFakturPenjualan = "{{ route('print.fakturpenjualantokotgl') }}"; 
            const baseUrlFakturDeposit = "{{ route('print.fakturdepositmasuktokotgl') }}"; 
            const baseUrlFakturDepositKeluar = "{{ route('print.fakturdepositkeluartokotgl') }}"; 
            const baseUrlFakturPenjualanMesinedc = "{{ route('print.fakturpenjualanmesinedctgl') }}"; 
            const baseUrlFakturPemesananMesinedc = "{{ route('print.fakturpemesananmesinedctgl') }}"; 
            const baseUrlFakturPenjualanQris = "{{ route('print.fakturpenjualanqristgl') }}"; 
            const baseUrlFakturPemesananQris = "{{ route('print.fakturpemesananqristgl') }}"; 
            const baseUrlFakturPenjualanTransfer = "{{ route('print.fakturpenjualantransfertgl') }}"; 
            const baseUrlFakturPemesananTransfer = "{{ route('print.fakturpemesanantransfertgl') }}"; 
            const baseUrlFakturPenjualanGobiz = "{{ route('print.fakturpenjualangobiztgl') }}"; 
            const baseUrlFakturPemesananGobiz = "{{ route('print.fakturpemesanangobiztgl') }}"; 
...
<script>
    $(document).ready(function () {
        $('#btnCari').on('click', function () {
            ...
            if (tanggalPenjualan) {
                $.ajax({
                    url: "{{ url('toko_tegal/get-penjualantegal') }}", // Sesuaikan URL sesuai dengan rute Anda
                    type: "POST",
                    data: {
                        _token: '{{ csrf_token() }}',
