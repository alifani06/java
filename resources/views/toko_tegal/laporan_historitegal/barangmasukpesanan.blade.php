...
@section('content')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ route('barangMasukpesanantegal') }}";
            form.submit();
        }
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_tegal/printLaporanBmpesanantegal') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'permintaan') {
            ...
            window.location.href = "{{ route('barangMasukpesanantegal') }}"; 
        }else if (selectedValue === 'semua') {
            window.location.href = "{{ route('barangMasuksemuategal') }}"; 
        }
    });
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_tegal/printExcelBmpesanantegal') }}";
    form.target = "_blank";
    form.submit();
}
</script>
