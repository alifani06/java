...
@section('content')
    ...
    <script>
        document.getElementById('kategori2').addEventListener('change', function() {
            ...
            if (selectedValue === 'bk') {
                window.location.href = "{{ url('toko_tegal/barangKeluarRincitegal') }}";
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ route('barangKeluarRincitegal') }}";
            form.submit();
        }
    </script>
...
<script>
    ...
    form.action = "{{ url('toko_tegal/printLaporanBKrincitegal') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_tegal/printExcelBktegal') }}";
    form.target = "_blank";
    form.submit();
}
</script>
