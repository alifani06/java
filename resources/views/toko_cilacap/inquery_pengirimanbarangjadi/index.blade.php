...
@section('content')
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($firstItem->status == 'unpost')
                                                ...
                                                <a class="dropdown-item"
                                                    href="{{ url('toko_cilacap/inquery_pengirimanbarangjadi/' . $firstItem->id . '/edit') }}">Update</a>
                                            
                                                <a class="dropdown-item"
                                                href="{{ url('/toko_cilacap/inquery_pengirimanbarangjadi/' . $firstItem->id ) }}">Show</a>
                                                @endif
                                        @if ($firstItem->status == 'posting')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_cilacap/inquery_pengirimanbarangjadi') }}";
            form.submit();
        }
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pengirimanbarangjadi/unpost_pengirimanbarangjadi/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pengirimanbarangjadi/posting_pengirimanbarangjadi/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
