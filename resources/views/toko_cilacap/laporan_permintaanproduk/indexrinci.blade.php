        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                        ...
                        {{-- <div class="float-right">
                            <a href="{{ route('toko_cilacap.penjualan_produk.pelunasan') }}"  class="btn btn-primary btn-sm">Pelunasan Pemesanan
                            </a>
                        </div> --}}
                            ...
                            @foreach ($inquery as $permintaan)
                                <tr class="permintaan-header" data-permintaan-id="{{ $permintaan->id }}">
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('toko_cilacap/permintaan_produk/' . $permintaan->id) }}" class="btn btn-info btn-sm">
...
<table id="datatables66" class="table table-bordered" style="font-size: 13px">
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_cilacap/laporan_penjualanproduk') }}";
            form.submit();
        }
    </script>
...
<script>
    ...
    form.action = "{{ url('toko_cilacap/printReportRinci') }}";
    form.target = "_blank";
    form.submit();
}
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'global') {
            window.location.href = "{{ url('toko_cilacap/laporan_permintaanproduk') }}";
        } else if (selectedValue === 'rinci') {
            window.location.href = "{{ url('toko_cilacap/indexrinci') }}";
        }
    });
</script>
