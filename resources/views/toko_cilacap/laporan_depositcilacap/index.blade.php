...
@section('content')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_cilacap/laporan_depositcilacap') }}";
            form.submit();
        }
    ...
    <script>
        document.getElementById('kategori1').addEventListener('change', function() {
            ...
            if (selectedValue === 'global') {
                window.location.href = "{{ url('toko_cilacap/laporan_depositcilacap') }}";
            } else if (selectedValue === 'rinci') {
                window.location.href = "{{ url('toko_cilacap/indexrinci') }}";
            } else if (selectedValue === 'saldo') {
                window.location.href = "{{ url('toko_cilacap/indexsaldo') }}";
            }
        });
    </script>
...
<script>
    ...
    form.action = "{{ url('toko_cilacap/printReportdeposit') }}";
    form.target = "_blank";
    form.submit();
}
