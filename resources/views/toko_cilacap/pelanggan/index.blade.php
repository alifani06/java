...
@section('content')
        ...
        @endif
            <div class="card">
                <div class="card-header">
                    ...
                    <a href="{{ url('toko_cilacap/pelanggan/create') }}" class="btn btn-primary btn-sm">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form method="GET" action="{{ url('toko_cilacap/pelanggan') }}" class="form-inline float-right">
                            ...
                            @foreach ($pelanggans as $pelanggan)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ url('toko_cilacap/pelanggan/' . $pelanggan->id) }}"
                                            class="btn btn-info btn-sm">
                                            <i class="fas fa-eye"></i>
                                        </a>
                                        <a href="{{ url('toko_cilacap/pelanggan/' . $pelanggan->id . '/edit') }}"
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer justify-content-between">
                                                ...
                                                <form action="{{ url('toko_cilacap/pelanggan/' . $pelanggan->id) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('delete')
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <div class="modal-footer justify-content-between">
                                                    ...
                                                    <a href="{{ url('toko_cilacap/pelanggan/cetak-qrcode/' . $pelanggan->id) }}"
        ...
        <div class="modal fade" id="modal-add">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div style="text-align: center;">
                            <form action="{{ url('toko_cilacap/pelanggan') }}" enctype="multipart/form-data"
    ...
    <script>
        function getData(id) {
            ...
            $.ajax({
                url: "{{ url('toko_cilacap/pelanggan/getpelanggan') }}" + "/" + pelanggan_id.value,
                type: "GET",
                dataType: "json",
