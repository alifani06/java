...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Retur Toko Cilacap</h1>
        ...
        <div class="container-fluid">
            ...
            <div class="card-body">
                <div class="float-right">
                    <a href="{{ url('toko_cilacap/retur_tokocilacap/create') }}" class="btn btn-primary btn-sm">
                                ...
                                <td>
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($firstItem->status == 'unpost')
                                                ...
                                                <a class="dropdown-item"
                                                href="{{ url('/toko_cilacap/retur_tokocilacap/' . $firstItem->id ) }}">Show</a>
                                                @endif
                                        @if ($firstItem->status == 'posting')
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/retur_tokocilacap/unpost_retur/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/retur_tokocilacap/posting_retur/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
