...
<body>
    ...
    @endforeach
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="{{ url('toko_cilacap/permintaan_produk') }}" class="btn btn-primary btn-sm">
            ...
            <div>
                <a href="{{ url('toko_cilacap/permintaan-produk/' . $permintaanProduk->id . '/print') }}" id="printButton" target="_blank" class="btn btn-primary btn-sm">
                    <i class="fas fa-print"></i> Cetak 
                </a>
            </div>
