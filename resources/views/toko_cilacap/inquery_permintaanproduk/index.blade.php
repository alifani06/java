...
@section('content')
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($permintaan->status == 'unpost')
                                                    ...
                                                    <a class="dropdown-item" href="{{ url('toko_cilacap/permintaan_produk/' . $permintaan->id . '/edit') }}">Update</a>
                                                    <a class="dropdown-item" href="{{ url('toko_cilacap/permintaan_produk/' . $permintaan->id) }}">Show</a>
                                                    <form action="{{ url('toko_cilacap/permintaan_produk/' . $permintaan->id) }}" method="POST" style="display: inline;">
                                                        @csrf
                                                        @method('DELETE')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_cilacap/inquery_permintaanproduk') }}";
            form.submit();
        }
  ...
  <script>
    $(document).ready(function() {
        $('.unpost-btn').click(function() {
            ...
            $.ajax({
                url: "{{ url('toko_cilacap/permintaan_produk/unpost_permintaanproduk/') }}/" + memoId,
                type: 'GET',
                data: {
                    id: memoId
                },
...
<script>
    $(document).ready(function() {
        $('.posting-btn').click(function() {
            ...
            $.ajax({
                url: "{{ url('toko_cilacap/permintaan_produk/posting_permintaanproduk/') }}/" + memoId,
                type: 'GET',
                data: {
                    id: memoId
                },
