...
<script>
    ...
    form.action = "{{ url('toko_cilacap/printReport') }}";
    form.target = "_blank";
    form.submit();
}
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'global') {
            window.location.href = "{{ url('toko_cilacap/indexglobal') }}";
        } else if (selectedValue === 'rinci') {
            window.location.href = "{{ url('toko_cilacap/laporan_penjualanproduk') }}";
        }
    });
</script>
