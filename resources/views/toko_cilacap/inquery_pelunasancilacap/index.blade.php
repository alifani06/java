...
@section('content')
                ...
                <div class="card-body">
                    <form method="GET" id="form-action">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <input class="form-control" id="tanggal_pelunasan" name="tanggal_pelunasan" type="date"
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 'unpost')
                                                    ...
                                                    {{-- <a class="dropdown-item"
                                                        href="{{ url('toko_cilacap/inquery_penjualanproduk/' . $item->id . '/edit') }}">Update</a> --}}
                                                
                                                    <a class="dropdown-item"
                                                    href="{{ url('/toko_cilacap/pelunasan_pemesananClc/' . $item->id ) }}">Show</a>
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ url('toko_cilacap/inquery_pelunasancilacap') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pelunasancilacap/unpost_penjualanproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pelunasancilacap/posting_penjualanproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
