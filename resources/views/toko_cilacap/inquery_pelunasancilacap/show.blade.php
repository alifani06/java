    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ url('toko_cilacap/inquery_penjualanprodukcilacap') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Kembali
                    </a>
                </div>
                <div>
                    <a href="{{ route('toko_cilacap.inquery_penjualanproduk.cetak-pdf', $penjualan->id) }}"  id="printButton" target="_blank" class="btn btn-primary btn-sm">
