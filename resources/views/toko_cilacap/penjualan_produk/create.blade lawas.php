...
.form-group input {
    ...
    <div class="content-header">
        <div class="container-fluid">
            ...
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Penjualan Produk Cilacap</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                    ...
                                    <tbody>
                                        @foreach ($produks as $item)
                                            @php
                                                ...
                                                $stok_tokocilacap = $item->stok_tokocilacap ? $item->stok_tokocilacap->jumlah : 0; // Jika stok ada, tampilkan, jika tidak tampilkan 0
                                            @endphp
                                            <tr class="pilih-btn"
                                                data-id="{{ $item->id }}"
                                                ...
                                                <td class="text-center">
                                                    {{ $stok_tokocilacap }} <!-- Tampilkan stok produk -->
                                                </td>
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'penjualan') {
            window.location.href = "{{ route('toko_cilacap.penjualan_produk.create') }}"; // Ganti dengan route yang sesuai untuk Penjualan
        } else if (selectedValue === 'pelunasan') {
            window.location.href = "{{ route('toko_cilacap.penjualan_produk.pelunasan') }}"; // Ganti dengan route yang sesuai untuk Pelunasan
        }
    });
</script>
