...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <a href="{{ url('toko_cilacap/pemesanan_produk/create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 'unpost')
                                                <a class="dropdown-item posting-btn"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('toko_cilacap/pemesanan_produk/' . $item->id . '/edit') }}">Update</a>
                                                
                                                    <a class="dropdown-item" 
                                                    href="{{ route('toko_cilacap.pemesanan_produk.cetak', $item->id) }}">Show</a>
                                            ...
                                            @if ($item->status == 'posting')
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('/toko_cilacap/pemesanan_produk/' . $item->id ) }}">Show</a>
                                            @endif
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_cilacap/inquery_pemesnanproduk') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pemesananproduk/unpost_pemesananproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_cilacap/inquery_pemesananproduk/posting_pemesananproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
