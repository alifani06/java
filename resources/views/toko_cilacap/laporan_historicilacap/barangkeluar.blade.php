...
@section('content')
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ url('toko_cilacap/barangKeluarcilacap') }}";
        form.submit();
     }
    </script>
...
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'bk') {
            window.location.href = "{{ url('toko_cilacap/barangKeluarRincicilacap') }}";
...
<script>
    ...
    form.action = "{{ url('toko_cilacap/printLaporanBKcilacap') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_cilacap/printExcelBkcilacap') }}";
    form.target = "_blank";
    form.submit();
}
</script>
