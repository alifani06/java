...
@section('content')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ route('barangMasukpesanancilacap') }}";
            form.submit();
        }
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'masuk') {
            window.location.href = "{{ url('toko_banjaran/laporan_historicilacap') }}";
        } else if (selectedValue === 'keluar') {
            window.location.href = "{{ url('toko_banjaran/barangKeluarcilacap') }}";
        }else if (selectedValue === 'retur') {
            window.location.href = "{{ url('toko_banjaran/barangReturcilacap') }}";
        }
    });
</script>
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_banjaran/printLaporanBmpesanancilacap') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_banjaran/printExcelBmpesanancilacap') }}";
    form.target = "_blank";
    form.submit();
}
</script>
