...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <h3 class="card-title">Laporan Barang Operan (Keluar)</h3>
                </div>
                <!-- /.card-header -->
                        ...
                        <div class="row">
                            <div class="col-md-3 mb-3" hidden>
                                <select class="custom-select form-control" id="toko_id" name="toko_id">
                                    <option value="6" selected>Toko Cilacap</option>
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ route('barangOperslawi') }}";
            form.submit();  
        }
    </script>
...
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'masuk') {
            window.location.href = "{{ route('barangOperancilacapMasuk') }}";
        } else if (selectedValue === 'keluar') {
            window.location.href = "{{ route('barangOpercilacap') }}"; 
        }
    });
</script>
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_cilacap/printLaporanBOcilacap') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_cilacap/printExcelBocilacap') }}";
    form.target = "_blank";
    form.submit();
}
</script>
