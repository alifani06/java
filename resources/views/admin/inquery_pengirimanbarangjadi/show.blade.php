...
<body>
    <div class="container">
        ...
        <div class="d-flex justify-content-between">
            ...
            {{-- <div>
                <a href="{{ route('inquery_pengirimanbarangjadi.print', $pengirimanBarangJadi->first()->id) }}" id="printButton" target="_blank" class="btn btn-primary btn-sm">
