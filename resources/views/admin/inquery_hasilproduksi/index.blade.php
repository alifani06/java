...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Hasil Produksi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    ...
                    <table id="datatables66" class="table table-bordered" style="font-size: 13px">
                        <thead>
                            <tr>
                                ...
                                <th>No Hasil Produksi</th>
                                <th>Tanggal Hasil Produksi</th>
                                <th>Status</th>
                            </tr>
                        </thead>
                        <tbody>
                            @foreach ($stokBarangJadi as $hasilproduksi)
                            @php
                                $firstItem = $hasilproduksi->first();
                            @endphp
                                ...
                                <!-- Menampilkan detailhasilproduksi -->
                                <tr class="permintaan-details" id="details-{{ $firstItem->id }}" style="display: none;">
                                    <td colspan="5">
                                        <table class="table table-bordered" style="font-size: 13px;">
                                            ...
                                            <tbody>
                                                @foreach ($firstItem->detailhasilproduksi as $detail)
                                                <tr>
                                                    <td>{{ $loop->iteration }}</td>
                                                    <td>{{ $detail->produk->klasifikasi->nama ?? 'Tidak Ditemukan' }}</td>
                                                    <td>{{ $detail->produk->kode_lama ?? 'Tidak Ditemukan' }}</td>
