...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Stok Hasil Produksi</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                ...
                <div class="card-body">
                    ...
                    <table id="datatables66" class="table table-bordered" style="font-size: 13px">
                        ...
                        <tbody>
                            ...
                            @foreach($stokBarangJadi as $stok)
                            <tr>
                                <td class="text-center">{{ $nomorUrut++ }}</td>
                                <td>{{ $stok->produk ? $stok->produk->kode_lama : 'Tidak ada kode' }}</td>
                                <td>{{ $stok->produk ? $stok->produk->nama_produk : 'Tidak ada nama' }}</td>
                                <td>{{ $stok->jumlah }}</td>
                            </tr>
                            @endforeach
                        </tbody>
