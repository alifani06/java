...
@section('content')
    ...
    <section class="content" style="display: none;" id="mainContentSection">
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{ url('admin/stok_barangjadi/' . $stok_barangjadi->id) }}" method="POST">
                        @csrf
                        @method('PUT')
                                                    ...
                                                    <table class="table table-bordered" style="font-size: 13px;">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr class="produk-row">
                                                                ...
                                                                <td>
                                                                    <input type="number" class="form-control" id="produk-{{ $produk->id }}" name="produk[{{ $produk->id }}][stok]" min="0" value="{{ $produk->pivot->stok ?? 0 }}" style="width: 100px; height: 30px;">
                                                                </td>
                                                            </tr>
                                                            @endforeach
                                                        </tbody>
