                            ...
                            <tr id="row-{{ $loop->index }}">
                                <form id="update-harga-form-{{ $index }}" method="POST" action="{{ route('update.harga') }}">
                                    ...
                                    <td>
                                     ...
                                     {{-- Slawi --}}
                                     <td style="text-align: center;">
                                        <input type="number" class="form-control form-control-sm"  name="member_harga_slw" id="member-harga-slw-{{ $loop->index }}" value="{{ $item->tokoslawi->first()->member_harga_slw ?? $item->harga }}" onchange="markAsChanged({{ $loop->index }})">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm"  name="member_diskon_slw" id="diskon-member-slw-{{ $loop->index }}" value="{{ $item->tokoslawi->first()->member_diskon_slw ?? $item->diskon }}" onchange="markAsChanged({{ $loop->index }})">
                                    </td>
                                    <td style="text-align: center;">
                                        <input type="number" class="form-control form-control-sm"  name="non_harga_slw" id="non-member-harga-slw-{{ $loop->index }}" value="{{ $item->tokoslawi->first()->non_harga_slw ?? $item->harga }}" onchange="markAsChanged({{ $loop->index }})">
                                    </td>
                                    <td>
                                        <input type="number" class="form-control form-control-sm"  name="non_diskon_slw" id="diskon-non-member-slw-{{ $loop->index }}" value="{{ $item->tokoslawi->first()->non_diskon_slw ?? $item->diskon }}" onchange="markAsChanged({{ $loop->index }})">
                                    </td>
                                </form>
                            </tr>
                            @endforeach
