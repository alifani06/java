    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">Data Harga Jual Tegal</h3>
                <div class="float-right">
                    <select class="form-control" id="kategori" name="kategori">
                        <option value="">- Pilih -</option>
                        <option value="banjaran" {{ old('kategori') == 'banjaran' ? 'selected' : '' }}>BANJARAN</option>
                        <option value="tegal" {{ old('kategori') == 'tegal' ? 'selected' : '' }}>TEGAL</option>
                        <option value="slawi" {{ old('kategori') == 'slawi' ? 'selected' : '' }}>SLAWI</option>
                        <option value="pemalang" {{ old('kategori') == 'pemalang' ? 'selected' : '' }}>PEMALANG</option>
                        <option value="bumiayu" {{ old('kategori') == 'bumiayu' ? 'selected' : '' }}>BUMIAYU</option>
                        <option value="cilacap" {{ old('kategori') == 'cilacap' ? 'selected' : '' }}>CILACAP</option>
                    </select>
                </div>
