...
@section('content')
    ...
    <section class="content">
                        ...
                        <div class="row mb-3 align-items-center">
                            <div class="col-auto mt-2">
                                ...
                                <div class="d-flex align-items-center">
                                    ...
                                    <button class="btn btn-primary ml-2" type="button" onclick="showCategoryModalpemesanan(this.value)">
                                        <i class="fas fa-search"></i>
                                    </button>
                                </div>
                            </div>
                            <div class="col-auto mt-2">
                                <label class="form-label" for="cabang">Tipe Pelanggan</label>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <button type="button" class="btn btn-primary btn-sm"
                                                onclick="getSelectedDataPemesanan('{{ $item->id }}','{{ $item->nama_pelanggan }}', '{{ $item->telp }}', '{{ $item->alamat}}')">
        ...
        <div class="modal fade" id="tableMarketing1" data-backdrop="static">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
    ...
    <script>
        function showCategoryModalpemesanan(selectedCategory) {
            $('#tableMarketing').modal('show');
        }
        
        function getSelectedDatapemesanan(id, nama_pelanggan, telp, alamat) {
