    ...
    <div class="container">
        ...
        <div>
            <p style="margin-bottom: 2px;">
                <strong>Kode Pengiriman:</strong> {{ $firstItem->kode_pengirimanpesanan }}
            </p>
            <p style="margin-bottom: 2px;">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <a href="{{ url('admin/pengiriman_barangjadipesanan') }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> Kembali
                </a>
            </div>
            <div>
                <a href="{{ route('pengiriman_barangjadipesanan.print', $firstItem->id) }}" id="printButton" target="_blank" class="btn btn-primary btn-sm">
