...
@section('content')
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                        ...
                        {{-- <div class="float-right">
                            <a href="{{ route('toko_pemalang.penjualan_produk.pelunasan') }}"  class="btn btn-primary btn-sm">Pelunasan Pemesanan
                            </a>
                        </div> --}}
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_pemalang/laporan_penjualanproduk') }}";
            form.submit();
        }
    </script>
...
<script>
    ...
    form.action = "{{ url('toko_pemalang/printReport') }}";
    form.target = "_blank";
    form.submit();
}
