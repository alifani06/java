...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Setoran Penjualan Pemalang</h1>
                </div><!-- /.col -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.penjualantoko.kotorpml') }}" 
                            id="penjualan_kotor_link_modal" 
                            class="btn btn-primary" 
                            target="_blank">Barang Keluar</a>

                            <a href="{{ route('print.fakturpenjualantokopml') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositkeluartokopml') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositmasuktokopml') }}" 
        ...
        <div class="modal fade" id="penjualanMesinedcModal" tabindex="-1" role="dialog" aria-labelledby="penjualanMesinedcModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanmesinedcpml') }}" 
                            id="penjualan_mesinedc_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananmesinedcpml') }}" 
        ...
        <div class="modal fade" id="penjualanQrisModal" tabindex="-1" role="dialog" aria-labelledby="penjualanQrisModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanqrispml') }}" 
                            id="penjualan_qris_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananqrispml') }}" 
        ...
        <div class="modal fade" id="penjualanTransferModal" tabindex="-1" role="dialog" aria-labelledby="penjualanTransferModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualantransferpml') }}" 
                            id="penjualan_transfer_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanantransferpml') }}" 
        ...
        <div class="modal fade" id="penjualanGobizModal" tabindex="-1" role="dialog" aria-labelledby="penjualanGobizModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualangobizpml') }}" 
                            id="penjualan_gobiz_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanangobizpml') }}" 
    ...
    <script>
        ...
        function updateModalLink() {
            ...
            const baseUrlBarangKeluar = "{{ route('print.penjualantoko.kotorpml') }}";
            const baseUrlFakturPenjualan = "{{ route('print.fakturpenjualantokopml') }}"; 
            const baseUrlFakturDeposit = "{{ route('print.fakturdepositmasuktokopml') }}"; 
            const baseUrlFakturDepositKeluar = "{{ route('print.fakturdepositkeluartokopml') }}"; 
            const baseUrlFakturPenjualanMesinedc = "{{ route('print.fakturpenjualanmesinedcpml') }}"; 
            const baseUrlFakturPemesananMesinedc = "{{ route('print.fakturpemesananmesinedcpml') }}"; 
            const baseUrlFakturPenjualanQris = "{{ route('print.fakturpenjualanqrispml') }}"; 
            const baseUrlFakturPemesananQris = "{{ route('print.fakturpemesananqrispml') }}"; 
            const baseUrlFakturPenjualanTransfer = "{{ route('print.fakturpenjualantransferpml') }}"; 
            const baseUrlFakturPemesananTransfer = "{{ route('print.fakturpemesanantransferpml') }}"; 
            const baseUrlFakturPenjualanGobiz = "{{ route('print.fakturpenjualangobizpml') }}"; 
            const baseUrlFakturPemesananGobiz = "{{ route('print.fakturpemesanangobizpml') }}"; 
