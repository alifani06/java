...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <a href="{{ url('toko_pemalang/penjualan_produk/create') }}" class="btn btn-primary btn-sm">
                                            ...
                                            @if ($item->status == 'unpost')
                                                <a class="dropdown-item posting-btn"
                                                    ...
                                                    <a class="dropdown-item"
                                                        href="{{ url('/toko_pemalang/penjualan_produk/' . $item->id ) }}">Show</a>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_pemalang/inquery_penjualanprodukbanjaran') }}";
            form.submit();
        }
    </script>
    ...
    <script>
        ...
        function printSelectedData() {
            ...
            if (selectedIds.length === 0) {
                ...
                window.location.href = "{{ url('toko_pemalang/cetak_fakturekspedisifilter') }}?ids=" + selectedIdsString;
                // var url = "{{ url('toko_pemalang/ban/cetak_pdffilter') }}?ids=" + selectedIdsString;
            }
        }
    </script>
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_pemalang/inquery_penjualanprodukbanjaran/unpost_penjualanproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_pemalang/inquery_penjualanprodukbanjaran/posting_penjualanproduk/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
