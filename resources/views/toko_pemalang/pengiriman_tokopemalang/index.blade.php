...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pengiriman Toko Pemalang (Permintaan)</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                ...
                                <td class="text-center">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($firstItem->status == 'unpost')
                                                ...
                                                href="{{ url('/toko_pemalang/pengiriman_tokopemalang/' . $firstItem->id)  }}">Show</a>
                                                @endif
                                        @if ($firstItem->status == 'posting')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_pemalang/pengiriman_tokopemalang') }}";
            form.submit();
        }
    ...
    <script>
        $(document).ready(function() {
            $('.unpost-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_pemalang/pengiriman_tokopemalang/unpost_pengiriman/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
    ...
    <script>
        $(document).ready(function() {
            $('.posting-btn').click(function() {
                ...
                $.ajax({
                    url: "{{ url('toko_pemalang/pengiriman_tokopemalang/posting_pengiriman/') }}/" + memoId,
                    type: 'GET',
                    data: {
                        id: memoId
                    },
