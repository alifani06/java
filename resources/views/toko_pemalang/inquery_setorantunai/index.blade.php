...
@section('content')
                                ...
                                <td>{{ number_format($item->plusminus, 0, ',', '.') }}</td>
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 'unpost')
                                            <a class="dropdown-item" href="{{ route('inquery_setorantunaipemalang.print', $item->id) }}" target="_blank">Print</a>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('tokoipemalang/inquery_setorantunaipemalang') }}";
            form.submit();
        }
    </script>
