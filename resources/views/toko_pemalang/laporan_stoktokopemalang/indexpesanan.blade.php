...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Data Stok Pesanan </h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        <li class="breadcrumb-item active">Data Stok Pesanan </li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <select class="custom-select form-control" id="toko" name="toko_id">
                                    ...
                                    <option value="1" {{ Request::get('toko_id') == '4' ? 'selected' : '' }}>Toko Pemalang</option>
    ...
    form.action = "{{ url('toko_pemalang/printstoktokopesananpemalang') }}";
    form.target = "_blank";
    form.submit();
}
    </script>
...
<script>
    function printExcel() {
        if (event) event.preventDefault();
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_pemalang/printexcelstokpesananpemalang') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
