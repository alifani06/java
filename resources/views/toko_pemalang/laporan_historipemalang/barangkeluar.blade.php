...
@section('content')
    ...
    <script>
        ...
        function cari() {
            ...
            form.action = "{{ url('toko_pemalang/barangKeluarpemalang') }}";
        form.submit();
     }
    </script>
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'masuk') {
            ...
            window.location.href = "{{ url('toko_pemalang/barangOperpemalang') }}";
        }
    });
</script>
...
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'bk') {
            window.location.href = "{{ url('toko_pemalang/barangKeluarRincipemalang') }}";
...
<script>
    ...
    form.action = "{{ url('toko_pemalang/printLaporanBKpemalang') }}";
    form.target = "_blank";
    form.submit();
    }
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_pemalang/printExcelBkpemalang') }}";
    form.target = "_blank";
    form.submit();
}
</script>
