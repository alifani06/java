...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Laporan Pengiriman Toko Pemalang</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Laporan Pengiriman Toko Pemalang</h3>
                </div>
...
<script>
    ...
    const tanggalPengiriman = document.getElementById('tanggal_input').value;
    const tanggalAkhir = document.getElementById('tanggal_akhir').value;
    const status = document.getElementById('status').value;

    form.action = `{{ url('toko_pemalang/printpengirimantokopemalang') }}?tanggal_input=${tanggalPengiriman}&tanggal_akhir=${tanggalAkhir}&status=${status}`;
    form.target = "_blank";
    form.submit();
}
