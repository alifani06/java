...
@section('content')
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($firstItem->status == 'unpost')
                                                ...
                                                <a class="dropdown-item posting-btn"
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('pengirimanpemesanan_tokobanjaran.show', $firstItem->id) }}">Show</a>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_banjaran/pengirimanpemesanan_tokobanjaran') }}";
            form.submit();
        }
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'permintaan') {
            ...
            window.location.href = "{{ route('pengirimanpemesanan_tokobanjaran.index') }}"; 
        }
    });
</script>
@endsection
