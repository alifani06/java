            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <a href="{{ url('toko_pemalang/permintaan_produk/create') }}" class="btn btn-primary btn-sm">
                            ...
                            <td class="text-center">
                                ...
                                <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                    @if ($permintaan->status == 'unpost')
                                            ...
                                            {{-- <a class="dropdown-item" href="{{ url('toko_pemalang/permintaan_produk/' . $permintaan->id . '/edit') }}">Update</a> --}}
                                            <a class="dropdown-item" href="{{ url('toko_pemalang/permintaan_produk/' . $permintaan->id) }}">Show</a>
