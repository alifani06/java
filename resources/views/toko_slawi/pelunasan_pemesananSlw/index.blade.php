            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-right">
                        <a href="{{ url('toko_slawi/pelunasan_pemesananSlw/create') }}" class="btn btn-primary btn-sm">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                            @if ($item->status == 'unpost')
                                                ...
                                                <a class="dropdown-item" href="{{ url('/toko_slawi/pelunasan_pemesananSlw/' . $item->id ) }}">Show</a>
