    ...
    <div class="container">
        ...
        <div class="section">
            ...
            <div class="d-flex justify-content-between">
                <div>
                    <a href="{{ url('toko_slawi/pelunasan_pemesananSlw') }}" class="btn btn-primary btn-sm">
                        <i class="fas fa-plus"></i> Kembali
                    </a>
                </div>
                <div>
                    <a href="{{ route('toko_slawi.pelunasan_pemesananSlw.cetak-pdf', $inquery->id) }}"  id="printButton" target="_blank" class="btn btn-primary btn-sm">
