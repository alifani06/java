...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Setoran Penjualan Slawi</h1>
                </div><!-- /.col -->
    ...
    <section class="content">
        ...
        @endif
            ...
            <form id="setoranForm" action="{{ url('toko_slawi/setoran_tokoslawi') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3 mb-3">
                                <select class="custom-select form-control" id="toko" name="toko_id" readonly>
                                    <option value="3" selected>SLAWI</option>
                                </select>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.penjualantoko.kotorslw') }}" 
                            id="penjualan_kotor_link_modal" 
                            class="btn btn-primary" 
                            target="_blank">Barang Keluar</a>

                            <a href="{{ route('print.fakturpenjualantokoslw') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositkeluartokoslw') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositmasuktokoslw') }}" 
        ...
        <div class="modal fade" id="penjualanMesinedcModal" tabindex="-1" role="dialog" aria-labelledby="penjualanMesinedcModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanmesinedcslw') }}" 
                            id="penjualan_mesinedc_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananmesinedcslw') }}" 
        ...
        <div class="modal fade" id="penjualanQrisModal" tabindex="-1" role="dialog" aria-labelledby="penjualanQrisModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanqrisslw') }}" 
                            id="penjualan_qris_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananqrisslw') }}" 
        ...
        <div class="modal fade" id="penjualanTransferModal" tabindex="-1" role="dialog" aria-labelledby="penjualanTransferModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualantransferslw') }}" 
                            id="penjualan_transfer_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanantransferslw') }}" 
        ...
        <div class="modal fade" id="penjualanGobizModal" tabindex="-1" role="dialog" aria-labelledby="penjualanGobizModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualangobizslw') }}" 
                            id="penjualan_gobiz_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanangobizslw') }}" 
    ...
    <script>
        ...
        function updateModalLink() {
            ...
            const baseUrlBarangKeluar = "{{ route('print.penjualantoko.kotorslw') }}";
            const baseUrlFakturPenjualan = "{{ route('print.fakturpenjualantokoslw') }}"; 
            const baseUrlFakturDeposit = "{{ route('print.fakturdepositmasuktokoslw') }}"; 
            const baseUrlFakturDepositKeluar = "{{ route('print.fakturdepositkeluartokoslw') }}"; 
            const baseUrlFakturPenjualanMesinedc = "{{ route('print.fakturpenjualanmesinedcslw') }}"; 
            const baseUrlFakturPemesananMesinedc = "{{ route('print.fakturpemesananmesinedcslw') }}"; 
            const baseUrlFakturPenjualanQris = "{{ route('print.fakturpenjualanqrisslw') }}"; 
            const baseUrlFakturPemesananQris = "{{ route('print.fakturpemesananqrisslw') }}"; 
            const baseUrlFakturPenjualanTransfer = "{{ route('print.fakturpenjualantransferslw') }}"; 
            const baseUrlFakturPemesananTransfer = "{{ route('print.fakturpemesanantransferslw') }}"; 
            const baseUrlFakturPenjualanGobiz = "{{ route('print.fakturpenjualangobizslw') }}"; 
            const baseUrlFakturPemesananGobiz = "{{ route('print.fakturpemesanangobizslw') }}"; 
...
<script>
    $(document).ready(function () {
        $('#btnCari').on('click', function () {
            ...
            if (tanggalPenjualan) {
                $.ajax({
                    url: "{{ url('toko_slawi/get-penjualanslawi') }}", // Sesuaikan URL sesuai dengan rute Anda
                    type: "POST",
                    data: {
                        _token: '{{ csrf_token() }}',
