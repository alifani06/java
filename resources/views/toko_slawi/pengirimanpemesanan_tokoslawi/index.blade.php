...
@section('content')
    ...
    <div class="content-header" style="display: none;" id="mainContent">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Inquery Pengiriman Toko Slawi (Pesanan)</h1>
                </div><!-- /.col -->
                <div class="col-sm-6">
                                    ...
                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                        @if ($firstItem->status == 'unpost')
                                                ...
                                                <a class="dropdown-item posting-btn"
                                                    ...
                                                    <a class="dropdown-item" href="{{ route('pengirimanpemesanan_tokoslawi.show', $firstItem->id) }}">Show</a>
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ url('toko_slawi/pengirimanpemesanan_tokoslawi') }}";
            form.submit();
        }
...
<script>
    document.getElementById('kategori1').addEventListener('change', function() {
        ...
        if (selectedValue === 'permintaan') {
            window.location.href = "{{ route('toko_slawi.pengiriman_tokoslawi.index') }}"; 
        } else if (selectedValue === 'pemesanan') {
            window.location.href = "{{ route('pengirimanpemesanan_tokoslawi.index') }}"; 
        }
    });
</script>
@endsection
