...
@section('content')
    ...
    <script>
        ...
        function cari() {
            form.action = "{{ route('barangMasukpesananslawi') }}";
            form.submit();
        }
...
<script>
    function printReport() {
        ...
        form.action = "{{ url('toko_slawi/printLaporanBmpesananslawi') }}";
        form.target = "_blank";
        form.submit();
    }
</script>
<script>
    document.getElementById('kategori2').addEventListener('change', function() {
        ...
        if (selectedValue === 'permintaan') {
            ...
            window.location.href = "{{ route('barangMasukpesananslawi') }}"; 
        }else if (selectedValue === 'semua') {
            window.location.href = "{{ route('barangMasuksemuaslawi') }}"; 
        }
    });
</script>
...
<script>
    ...
    const form = document.getElementById('form-action');
    form.action = "{{ url('toko_slawi/printExcelBmpesananslawi') }}";
    form.target = "_blank";
    form.submit();
}
</script>
