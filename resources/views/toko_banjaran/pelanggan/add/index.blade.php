...
@section('content')
    ...
    <section class="content">
        <div class="container-fluid">
            ...
            <!-- /.card-header -->
            <form action="{{ url('tambah') }}" method="POST" enctype="multipart/form-data" autocomplete="off">
                @csrf
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title">Tambah Pelanggan</h3>
                    ...
                    <div class="form-group  mb-3">
                        <input type="text" class="form-control" id="kode_pelanggan" name="kode_pelanggan"
                            placeholder="Masukan kode pelanggan" value="" hidden>
                    </div>
                    <div class="form-group  mb-3">
                        <input type="text" class="form-control" id="qrcode_pelanggan" name="qrcode_pelanggan"
                            placeholder="Masukan kode pelanggan" value="https://javabakery.id/pelanggan/" hidden>
                    </div>
                    <div class="form-group  mb-3">
                        <label for="kode_lama">Kode Pelanggan Lama</label>
                        <input type="text" class="form-control" id="kode_lama" name="kode_lama"
                            placeholder="Masukan kode pelanggan lama" value="{{ old('kode_lama') }}" >
                    </div>
                        <div class="form-group  mb-3">
