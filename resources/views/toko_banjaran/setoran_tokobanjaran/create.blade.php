...
@section('content')
    ...
    <div class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1 class="m-0">Setoran Penjualan Banjaran</h1>
                </div><!-- /.col -->
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.penjualantoko.kotorbnj') }}" 
                            id="penjualan_kotor_link_modal" 
                            class="btn btn-primary" 
                            target="_blank">Barang Keluar</a>

                            <a href="{{ route('print.fakturpenjualantokobnj') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositkeluartokobnj') }}" 
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="d-flex justify-content-around">
                            ...
                            <a href="{{ route('print.fakturdepositmasuktokobnj') }}" 
        ...
        <div class="modal fade" id="penjualanMesinedcModal" tabindex="-1" role="dialog" aria-labelledby="penjualanMesinedcModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanmesinedcbnj') }}" 
                            id="penjualan_mesinedc_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananmesinedcbnj') }}" 
        ...
        <div class="modal fade" id="penjualanQrisModal" tabindex="-1" role="dialog" aria-labelledby="penjualanQrisModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualanqrisbnj') }}" 
                            id="penjualan_qris_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesananqrisbnj') }}" 
        ...
        <div class="modal fade" id="penjualanTransferModal" tabindex="-1" role="dialog" aria-labelledby="penjualanTransferModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualantransferbnj') }}" 
                            id="penjualan_transfer_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanantransferbnj') }}" 
        ...
        <div class="modal fade" id="penjualanGobizModal" tabindex="-1" role="dialog" aria-labelledby="penjualanGobizModalLabel" aria-hidden="true">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="d-flex justify-content-around">
                            <a href="{{ route('print.fakturpenjualangobizbnj') }}" 
                            id="penjualan_gobiz_link_modal" 
                            class="btn btn-secondary"
                            target="_blank">Faktur Penjualan</a>

                            <a href="{{ route('print.fakturpemesanangobizbnj') }}" 
    ...
    <script>
        ...
        function updateModalLink() {
            ...
            const baseUrlBarangKeluar = "{{ route('print.penjualantoko.kotorbnj') }}";
            const baseUrlFakturPenjualan = "{{ route('print.fakturpenjualantokobnj') }}"; 
            const baseUrlFakturDeposit = "{{ route('print.fakturdepositmasuktokobnj') }}"; 
            const baseUrlFakturDepositKeluar = "{{ route('print.fakturdepositkeluartokobnj') }}"; 
            const baseUrlFakturPenjualanMesinedc = "{{ route('print.fakturpenjualanmesinedcbnj') }}"; 
            const baseUrlFakturPemesananMesinedc = "{{ route('print.fakturpemesananmesinedcbnj') }}"; 
            const baseUrlFakturPenjualanQris = "{{ route('print.fakturpenjualanqrisbnj') }}"; 
            const baseUrlFakturPemesananQris = "{{ route('print.fakturpemesananqrisbnj') }}"; 
            const baseUrlFakturPenjualanTransfer = "{{ route('print.fakturpenjualantransferbnj') }}"; 
            const baseUrlFakturPemesananTransfer = "{{ route('print.fakturpemesanantransferbnj') }}"; 
            const baseUrlFakturPenjualanGobiz = "{{ route('print.fakturpenjualangobizbnj') }}"; 
            const baseUrlFakturPemesananGobiz = "{{ route('print.fakturpemesanangobizbnj') }}"; 
...
<script>
    $(document).ready(function () {
        $('#btnCari').on('click', function () {
            ...
            if (tanggalPenjualan) {
                $.ajax({
                    url: "{{ url('toko_banjaran/get-penjualanbanjaran') }}", // Sesuaikan URL sesuai dengan rute Anda
                    type: "POST",
                    data: {
                        _token: '{{ csrf_token() }}',
