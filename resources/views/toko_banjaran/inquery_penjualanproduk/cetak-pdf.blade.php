...
<body>
    <div class="container">
        ...
        <div class="section">
                ...
                <table style="font-size: 12px; width: 100%;">
                    ...
                    <tbody>
                       ...
                       @php
                           ...
                           $nama_produk = wordwrap($detail->nama_produk, 9, "\n", true);
                       @endphp
                       <tr>
            ...
            <div class="terimakasihd" style="text-align: left; font-size: 12px; margin-top: -35px">
                <p><i>Re-print  {{ \Carbon\Carbon::now()->translatedFormat('d M Y') }}</i></p>
            </div>
