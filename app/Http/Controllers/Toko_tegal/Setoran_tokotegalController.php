...
class Setoran_tokotegalController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 2) 
    ...
    public function getdatategal(Request $request)
    {
    ...
    public function printPenjualanKotortgl(Request $request)
    {
        ...
        return view('toko_tegal.setoran_tokotegal.printpenjualantoko', [
    ...
    public function printFakturPenjualantgl(Request $request)
    {
        ...
        // Buat PDF
        return view('toko_tegal.setoran_tokotegal.printfakturpenjualantoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturdepositKeluartgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_tegal.setoran_tokotegal.printfakturdepositkeluartoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanMesinedctgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananMesinedctgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_tegal.setoran_tokotegal.printfakturdepositmasuktoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanQristgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananQristgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanTransfertgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananTransfertgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanGobiztgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananGobiztgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturdepositMasuktgl(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printPenjualanDiskontgl(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
        ...
        $pdf = FacadePdf::loadView('toko_tegal.setoran_tokotegal.printpenjualantoko', [
            'finalResults' => $finalResults,
            'startDate' => $tanggal_penjualan,
            'branchName' => $branchName,
        ]);
    ...
    public function printPenjualanBersihtgl(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
    ...
    public function show($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_tegal.setoran_tokotegal.detail', compact('penjualan', 'tokos', 'pelanggans'));
    ...
    public function show1($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_tegal.setoran_tokotegal.detailpemesanan', compact('pemesanan', 'tokos', 'pelanggans','dp'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function show2($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_tegal.setoran_tokotegal.detaildepositkeluar', compact('inquery', 'tokos', 'pelanggans'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('setoran_tokotegal.index')->with('success', 'Data berhasil disimpan dan status penjualan berhasil diperbarui!');
    }
