...
class Laporan_stoktokotegalController extends Controller
{
    ...
    public function printReport(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_tegal.laporan_stoktokotegal.print', [
    ...
    public function printReportstokpesanantegal(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_tegal.laporan_stoktokotegal.printpesanan', [
            'produkWithStok' => $produkWithStok,
            'klasifikasis' => $klasifikasis,
            'subklasifikasis' => $subklasifikasis,
            'totalHarga' => $totalHarga,
    ...
    public function exportExcelsemua(Request $request)
    {
        ...
        $stokToko = Stok_tokotegal::with('produk')->get();
        $stokPesanan = Stokpesanan_tokotegal::with('produk')->get();
