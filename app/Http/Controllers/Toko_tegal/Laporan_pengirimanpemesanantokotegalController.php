...
class Laporan_pengirimanpemesanantokotegalController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            $query = Pengirimanpemesanan_tokotegal::with('produk.klasifikasi');
            ...
            return view('toko_tegal.laporan_pengirimanpemesanantokotegal.index', compact('stokBarangJadi'));
    }
