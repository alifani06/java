...
use App\Imports\PermintaanImportSlawi;
use Maatwebsite\Excel\Facades\Excel;




class PermintaanprodukslawiController extends Controller{
...
// public function importslawi(Request $request)
// {
...
//     $import = new PermintaanImportSlawi;
...
public function importslawi(Request $request)
{
    ...
    return redirect('toko_slawi/permintaan_produk')->with('success', 'Berhasil menambahkan karyawan');
