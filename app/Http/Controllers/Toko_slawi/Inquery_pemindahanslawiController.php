...
//                 //Memasukkan data ke stok_tokoslawi
//                 Stok_tokoslawi::create([
//                     'produk_id' => $pemindahan->produk_id,
//                     'jumlah' => $pemindahan->jumlah,
//                     'pengiriman_barangjadi_id' => null, // Set null sesuai permintaan
//                     'kode_pengiriman' => null,          // Set null sesuai permintaan
//                     'status' => 'posting',
//                     'tanggal_input' => null, 
...
public function posting_pemindahan($id)
{
    ...
    if ($pemindahan->status == 'unpost') {
        ...
        switch ($pemindahan->toko_id) {
            ...
            case 3: // Jika toko_id = 3, update pemindahan_tokoslawi dan stok_tokoslawi
                Pemindahan_tokoslawi::where('kode_pemindahan', $pemindahan->kode_pemindahan)
                    ->update([
                        'status' => 'posting',
                        'tanggal_terima' => Carbon::now('Asia/Jakarta'),
                ...
                // Ambil stok yang ada di Stok_tokoslawi
                $stok_slawi = Stok_tokoslawi::where('produk_id', $pemindahan->produk_id)
                    ->where('jumlah', '>', 0)
                    ->orderBy('jumlah', 'asc')
                    ->get();
