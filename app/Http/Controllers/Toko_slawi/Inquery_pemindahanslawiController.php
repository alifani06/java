...
public function posting_pemindahan($id)
{
    ...
    if ($pemindahan->status == 'unpost') {
        ...
        $pemindahan->update(['status' => 'posting']);
        return redirect()->route('pemindahan_tokoslawi.index')->with('success', 'Status berhasil diubah menjadi posting dan stok telah diperbarui.');
    }
