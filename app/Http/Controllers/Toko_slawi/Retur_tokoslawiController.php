...
public function show($id)
{
    ...
    return view('toko_slawi.retur_tokoslawi.show', compact('pengirimanBarangJadi', 'firstItem'));
}
...
public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.retur_tokoslawi.print', compact('pengirimanBarangJadi', 'firstItem'));
