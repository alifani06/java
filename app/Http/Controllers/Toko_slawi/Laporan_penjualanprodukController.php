    ...
    public function index(Request $request)
{
    ...
    // Query dasar untuk mengambil data penjualan produk dengan toko_id = 3
    $query = Penjualanproduk::where('toko_id', 3);
...
public function printReportglobal(Request $request)
{
    ...
    $html = view('toko_slawi.laporan_penjualanproduk.printglobal', [
        'inquery' => $inquery,
        'startDate' => $formattedStartDate,
        'endDate' => $formattedEndDate,
