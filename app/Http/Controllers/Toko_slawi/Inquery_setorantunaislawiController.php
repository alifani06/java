...
class Inquery_setorantunaislawiController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Kirim data ke view
        return view('toko_slawi.inquery_setorantunai.index', compact('setoranPenjualans'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_slawi.setoran_tokobanjaran.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
...
//     $pdf = FacadePdf::loadView('toko_slawi.inquery_setorantunai.print', compact(
//         'inquery',
//         'kasirs',
//         'penjualan_kotor',
//         'diskon_penjualan',
...
// }
    ...
    public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.inquery_setorantunai.print', compact('setoranPenjualans'));
