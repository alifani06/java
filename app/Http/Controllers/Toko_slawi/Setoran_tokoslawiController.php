...
class Setoran_tokoslawiController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Ambil semua data setoran penjualan dengan filter tanggal dan toko_id = 1 (jika ada)
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 3) // Filter berdasarkan toko_id
        ...
        // Kirim data ke view
        return view('toko_slawi.setoran_tokoslawi.index', compact('setoranPenjualans'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_slawi.setoran_tokoslawi.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
    ...
    public function getdataslawi(Request $request)
    {
    ...
    public function printPenjualanKotorslw(Request $request)
    {
        ...
        return view('toko_slawi.setoran_tokoslawi.printpenjualantoko', [
    ...
    public function printFakturPenjualanslw(Request $request)
    {
        ...
        // Buat PDF
        return view('toko_slawi.setoran_tokoslawi.printfakturpenjualantoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturdepositKeluarslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_slawi.setoran_tokoslawi.printfakturdepositkeluartoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanMesinedcslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananMesinedcslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_slawi.setoran_tokoslawi.printfakturdepositmasuktoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanQrisslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananQrisslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanTransferslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananTransferslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanGobizslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananGobizslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturdepositMasukslw(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printPenjualanDiskonslw(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
        ...
        $pdf = FacadePdf::loadView('toko_slawi.setoran_tokoslawi.printpenjualantoko', [
            'finalResults' => $finalResults,
            'startDate' => $tanggal_penjualan,
            'branchName' => $branchName,
        ]);
    ...
    public function printPenjualanBersihslw(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
    ...
    public function show($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.setoran_tokoslawi.detail', compact('penjualan', 'tokos', 'pelanggans'));
    ...
    public function show1($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.setoran_tokoslawi.detailpemesanan', compact('pemesanan', 'tokos', 'pelanggans','dp'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function show2($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.setoran_tokoslawi.detaildepositkeluar', compact('inquery', 'tokos', 'pelanggans'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('setoran_tokoslawi.index')->with('success', 'Data berhasil disimpan dan status penjualan berhasil diperbarui!');
    }
