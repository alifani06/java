...
class Setoran_tokoslawiController extends Controller
{
    ...
    {
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 3)
            ->orderBy('id', 'DESC')
            ->get();
    ...
    public function store(Request $request)
    {
        ...
        Setoran_penjualan::create([
            ...
            'toko_id' => 3, // Ambil nilai toko_id dari request
            'status' => 'unpost',
        ]);
    
        // Redirect ke halaman index dengan pesan sukses
        return redirect()->route('setoran_tokoslawi.index')->with('success', 'Data berhasil disimpan!');
    }
    ...
    public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_slawi.setoran_tokoslawi.printtunai', compact('setoranPenjualans'));
