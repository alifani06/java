...
class Inquery_setorantunaipemalangController extends Controller
{
    public function index(Request $request)
    {
        ...
        // Kirim data ke view
        return view('toko_pemalang.inquery_setorantunai.index', compact('setoranPenjualans'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_pemalang.setoran_tokobanjaran.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
...
//     $pdf = FacadePdf::loadView('toko_pemalang.inquery_setorantunai.print', compact(
//         'inquery',
//         'kasirs',
//         'penjualan_kotor',
//         'diskon_penjualan',
...
// }
    ...
    public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.inquery_setorantunai.print', compact('setoranPenjualans'));
