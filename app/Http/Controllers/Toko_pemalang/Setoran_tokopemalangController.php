...
class Setoran_tokopemalangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 4) 
    ...
    public function getdatapemalang(Request $request)
    {
    ...
    public function printPenjualanKotorpml(Request $request)
    {
        ...
        return view('toko_pemalang.setoran_tokopemalang.printpenjualantoko', [
    ...
    public function printFakturPenjualanpml(Request $request)
    {
        ...
        // Buat PDF
        return view('toko_pemalang.setoran_tokopemalang.printfakturpenjualantoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturdepositKeluarpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_pemalang.setoran_tokopemalang.printfakturdepositkeluartoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanMesinedcpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananMesinedcpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
        ...
        // Buat PDF
        return view('toko_pemalang.setoran_tokopemalang.printfakturdepositmasuktoko', [
            'inquery' => $inquery,
            'startDate' => $startDate,
            'endDate' => $endDate,
            'branchName' => $branchName,
    ...
    public function printFakturPenjualanQrispml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananQrispml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanTransferpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananTransferpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPenjualanGobizpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturPemesananGobizpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printFakturdepositMasukpml(Request $request)
    {
        $tanggal_penjualan = $request->get('tanggal_penjualan');
        $toko_id = $request->get('toko_id');
    ...
    public function printPenjualanDiskonpml(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.setoran_tokopemalang.printpenjualantoko', [
            'finalResults' => $finalResults,
            'startDate' => $tanggal_penjualan,
            'branchName' => $branchName,
        ]);
    ...
    public function printPenjualanBersihpml(Request $request)
    {
        // Ambil parameter tanggal_penjualan dan toko_id dari request
        $tanggal_penjualan = $request->get('tanggal_penjualan'); // Menggunakan query string
        $toko_id = $request->get('toko_id'); // Mengambil toko_id dari query string
    ...
    public function show($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.setoran_tokopemalang.detail', compact('penjualan', 'tokos', 'pelanggans'));
    ...
    public function show1($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.setoran_tokopemalang.detailpemesanan', compact('pemesanan', 'tokos', 'pelanggans','dp'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function show2($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.setoran_tokopemalang.detaildepositkeluar', compact('inquery', 'tokos', 'pelanggans'));
        $pdf->setPaper('a4', 'portrait');
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('setoran_tokopemalang.index')->with('success', 'Data berhasil disimpan dan status penjualan berhasil diperbarui!');
    }
