...
class Laporan_depositpemalangController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Kirim data ke view
        return view('toko_pemalang.laporan_depositpemalang.index', compact('inquery', 'tokos'));
    }
    ...
    public function indexrinci(Request $request)
    {
        ...
        // Kirim data ke view
        return view('toko_pemalang.laporan_depositpemalang.indexrinci', compact('inquery', 'tokos'));
    }
    ...
    public function indexsaldo(Request $request)
    {
        ...
        // Kirim data ke view
        return view('toko_pemalang.laporan_depositpemalang.indexsaldo', compact('saldoPerToko', 'tokos', 'toko_id'));
    }
    ...
    public function printReportdeposit(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.laporan_depositpemalang.print', [
            'inquery' => $inquery,
            'tokos' => $tokos,
            'status' => $status,
    ...
    //     // Buat PDF menggunakan Facade PDF
    //     $pdf = FacadePdf::loadView('toko_pemalang.laporan_depositpemalang.printrinci', [
    //         'inquery' => $inquery,
    //         'tokos' => $tokos,
    //         'status' => $status,
    //         'startDate' => $formattedStartDate,
    ...
    public function printReportdepositrinci(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_pemalang.laporan_depositpemalang.printrinci', compact(
            'inquery', 
            'tokos', 
            'status', 
            'tanggal_kirim', 
    ...
    public function printReportsaldo(Request $request)
    {
        ...
        // Kirim data ke view cetak
        $pdf = FacadePdf::loadView('toko_pemalang.laporan_depositpemalang.printsaldo', compact(
            'saldoPerToko',
            'tokos',
            'toko_id',
            'branchName',
