...
class AddpelangganController extends Controller
{
    public function index()
    {
        ...
        return view('toko_banjaran/pelanggan/add.index', compact('pelanggans'));
    }

    public function create()
    {
        return view('toko_banjaran/pelanggan/add/index');
    ...
    public function store(Request $request)
    {
        ...
        return redirect('toko_banjaran/pelanggan/')->with('success', 'Berhasil menambahkan pelanggan');
    }
    ...
    //     return view('toko_banjaran/barang.update', compact('barang'));
    // }
    ...
    //     return redirect('toko_banjaran/barang')->with('success', 'Berhasil memperbarui barang');
    // }
    ...
    //     $pdf->loadView('toko_banjaran.barang.cetak_pdf', compact('barangs'));
    ...
    //     $barang = Barang::where('id', $id)->first();
    //     return view('toko_banjaran/barang.show', compact('barang'));
    // }
    ...
    public function destroy($id)
    {
        ...
        return redirect('toko_banjaran/pelanggan')->with('success', 'Berhasil menghapus barang');
    }
}