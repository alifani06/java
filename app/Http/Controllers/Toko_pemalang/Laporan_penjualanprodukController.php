    ...
    public function index(Request $request)
{
    ...
    $query = Penjualanproduk::where('toko_id', 4);
    ...
    return view('toko_pemalang.laporan_penjualanproduk.index', compact('inquery', 'produks', 'tokos', 'klasifikasis'));
}
    ...
    public function indexglobal(Request $request)
    {
        ...
        return view('toko_pemalang.laporan_penjualanproduk.global', compact('inquery', 'produks', 'tokos', 'klasifikasis'));
    }
...
public function printReport(Request $request)
{
    ...
    // Generate PDF
    $pdf = FacadePdf::loadView('toko_pemalang.laporan_penjualanproduk.print', [
        'inquery' => $inquery,
...
public function printReportglobal(Request $request)
{
    ...
    // Default toko_id ke 4 jika tidak ada yang dipilih
    if (!$toko_id) {
        $toko_id = 4; // ID Toko Banjaran
    }
    ...
    $html = view('toko_pemalang.laporan_penjualanproduk.printglobal', [
        'inquery' => $inquery,
        'startDate' => $formattedStartDate,
        'endDate' => $formattedEndDate,
