    ...
    public function index(Request $request)
{
    ...
    $toko_id = 4;  // Tetapkan toko_id langsung menjadi 1
...
public function barangMasukpesananpemalang(Request $request)
{
    ...
    public function barangMasuksemuapemalang(Request $request)
{
    $status = $request->status;
    $tanggal_pengiriman = $request->tanggal_pengiriman;
    $tanggal_akhir = $request->tanggal_akhir;
    ...
    // Toko_id 1
    $query1->where('pengiriman_barangjadis.toko_id', 4);
    $query2->where('pengiriman_barangjadipesanans.toko_id', 4);
    ...
    // Kirim data ke view
    return view('toko_pemalang.laporan_historipemalang.barangmasuksemua', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'produks'));
}

public function barangKeluarpemalang(Request $request)
{
    $status = $request->status;
...
public function barangKeluarRincipemalang(Request $request)
{
    $status = $request->status;
    $tanggal_penjualan = $request->tanggal_penjualan;
    $tanggal_akhir = $request->tanggal_akhir;
    ...
    public function barangReturpemalang(Request $request)
    {
        $status = $request->status;
    ...
    public function printLaporanBmpemalang(Request $request)
    {
        ...
        // Nama toko default
        $branchName = 'Toko Pemalang'; // Mengganti dengan nama toko yang sesuai
    ...
    public function printLaporanBmpesananpemalang(Request $request)
    {
        // Ambil parameter filter dari request
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        ...
        $query = Pengiriman_barangjadipesanan::join('produks', 'pengiriman_barangjadipesanans.produk_id', '=', 'produks.id')
            ...
            ->with('produk.klasifikasi')
            ->where('toko_id', 4); // Toko ID statis menjadi 3
    ...
    public function printLaporanBmsemuapemalang(Request $request)
    {
        // Ambil parameter filter dari request
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        ...
        // Memuat konten HTML dari view
        $pdf = FacadePdf::loadView('toko_pemalang.laporan_historipemalang.printbmsemua', [
            'groupedData' => $groupedData,
            'startDate' => $formattedStartDate,
            'endDate' => $formattedEndDate,
            'branchName' => $branchName,
    ...
    public function printLaporanBKpemalang(Request $request)
{
    // Ambil parameter filter dari request
    $status = $request->status;
    $tanggal_penjualan = $request->tanggal_penjualan;
    ...
    public function printLaporanBKrincipemalang(Request $request)
{
    // Ambil parameter filter dari request
    $status = $request->status;
    $tanggal_penjualan = $request->tanggal_penjualan;
    ...
    public function printLaporanBRpemalang(Request $request)
{
    // Ambil parameter filter dari request
    $status = $request->status;
    $tanggal_retur = $request->tanggal_retur;
