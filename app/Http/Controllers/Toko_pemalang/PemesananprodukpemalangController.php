...
public function store(Request $request)
{
    ...
    $validasi_pelanggan = Validator::make(
        ...
        [
            ...
            'kategori' => 'required',
            'tanggal_kirim' => 'required', // Tambahkan ini
            'dp_pemesanan' => 'required|numeric|min:1', // Validasi DP tidak boleh kosong dan harus lebih dari 0
        ],
        [
            'nama_pelanggan.required' => 'Masukkan nama pelanggan',
            'telp.nullable' => 'Masukkan telepon',
            ...
            'kategori.required' => 'Pilih kategori pelanggan',
            'tanggal_kirim.required' => 'Tanggal pengambilan harus diisi', // Tambahkan ini
            'dp_pemesanan.required' => 'DP tidak boleh kosong', // Notifikasi jika DP tidak diisi
            'dp_pemesanan.numeric' => 'DP harus berupa angka', // Notifikasi jika DP bukan angka
            'dp_pemesanan.min' => 'DP minimal 1', // Notifikasi jika DP kurang dari 1
        ]
    );
