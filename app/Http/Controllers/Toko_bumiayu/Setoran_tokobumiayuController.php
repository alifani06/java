...
class Setoran_tokobumiayuController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Setoran_penjualan::create([
            ...
            'toko_id' => 5, // Ambil nilai toko_id dari request
            'status' => 'unpost',
        ]);
    
        // Redirect ke halaman index dengan pesan sukses
        return redirect()->route('setoran_tokobumiayu.index')->with('success', 'Data berhasil disimpan!');
    }
    ...
    public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_bumiayu.setoran_tokobumiayu.printtunai', compact('setoranPenjualans'));
