...
class Pengirimanpemesanan_tokobumiayuController extends Controller{
    ...
    public function index(Request $request)
    {
        ...
        $query = Pengirimanpemesanan_tokobumiayu::with(['pengiriman_barangjadipesanan.produk.klasifikasi']);
    ...
    public function show($id)
    {
        ...
        $detailStokBarangJadi = Pengirimanpemesanan_tokobumiayu::where('id', $id)->value('kode_pengirimanpesanan');
        ...
        $pengirimanBarangJadi = Pengirimanpemesanan_tokobumiayu::with(['produk.subklasifikasi', 'toko'])->where('kode_pengirimanpesanan', $detailStokBarangJadi)->get();
