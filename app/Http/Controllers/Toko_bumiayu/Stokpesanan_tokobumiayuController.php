...
public function create()
{
    ...
    return view('toko_bumiayu.stokpesanan_tokobumiayu.create', compact('produks', 'tokos'));
}
    ...
    public function store(Request $request)
    {
        ...
        foreach ($produk_ids as $index => $produk_id) {
            $stok = Stokpesanan_tokobumiayu::where('produk_id', $produk_id)->first();
        ...
        return redirect()->route('stokpesanan_tokobumiayu.index')->with('success', 'Data stok barang berhasil disimpan.');
    }
    ...
    public function update(Request $request, $produk_id)
    {
        ...
        if (!$stok) {
            return redirect()->route('stokpesanan_tokobumiayu.index')->with('error', 'Stok untuk produk ini tidak ditemukan.');
        }
        ...
        return redirect()->route('stokpesanan_tokobumiayu.index')->with('success', 'Stok produk berhasil diperbarui.');
    }
    ...
    public function deleteAll()
    {
        ...
        Stokpesanan_tokobumiayu::query()->update(['jumlah' => 0]);
