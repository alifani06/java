...
class Inquery_setorantunaibumiayuController extends Controller
{
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_bumiayu.setoran_tokobanjaran.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
...
//     $pdf = FacadePdf::loadView('toko_bumiayu.inquery_setorantunai.print', compact(
//         'inquery',
//         'kasirs',
//         'penjualan_kotor',
//         'diskon_penjualan',
...
// }
    ...
    public function print($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_bumiayu.inquery_setorantunai.print', compact('setoranPenjualans'));
