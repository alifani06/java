...
class Stok_tokobumiayuController extends Controller{
...
public function index(Request $request)
{
    ...
    $stok_tokobanjaran = Stok_tokobumiayu::with('produk')->get();
    ...
    return view('toko_bumiayu.stok_tokobumiayu.index', compact('produkWithStok', 'klasifikasis', 'subklasifikasis', 'totalHarga', 'totalStok', 'totalSubTotal'));
}
...
public function create()
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('stok_tokobumiayu.index')->with('success', 'Data stok barang berhasil disimpan.');
    }
