...
class Laporan_stoktokobumiayuController extends Controller
{
    ...
    public function printReport(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_bumiayu.laporan_stoktokobumiayu.print', [
    ...
    public function printReportstokpesananbumiayu(Request $request)
    {
        ...
        $pdf = FacadePdf::loadView('toko_bumiayu.laporan_stoktokobumiayu.printpesanan', [
            'produkWithStok' => $produkWithStok,
            'klasifikasis' => $klasifikasis,
            'subklasifikasis' => $subklasifikasis,
            'totalHarga' => $totalHarga,
    ...
    public function printReportsemuastokbumiayu(Request $request)
    {
        ...
        // Membuat PDF menggunakan FacadePDF
        $pdf = FacadePdf::loadView('toko_bumiayu.laporan_stoktokobumiayu.printsemuastok', [
            'produkWithStok' => $produkWithStok,
            'klasifikasis' => $klasifikasis,
            'subklasifikasis' => $subklasifikasis,
            'totalHarga' => $totalHarga,
            'totalStok' => $totalStok,
            'totalSubTotal' => $totalSubTotal,
            'tokoCabang' => 'BUMIAYU', // Ini harus ada untuk menyertakan variabel
        ]);
    ...
    public function exportExcelsemua(Request $request)
    {
        ...
        $stokToko = Stok_tokobumiayu::with('produk')->get();
        $stokPesanan = Stokpesanan_tokobumiayu::with('produk')->get();
