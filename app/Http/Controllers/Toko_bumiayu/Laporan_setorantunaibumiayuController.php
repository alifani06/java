...
class Laporan_setorantunaibumiayuController extends Controller
{
    ...
    //     // Kirim data ke view
    //     return view('toko_bumiayu.laporan_setorantunai.index', compact('setoranPenjualans'));
    // }
    ...
    public function index(Request $request)
    {
        ...
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 2) // Filter berdasarkan toko_id = 2
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_bumiayu.setoran_tokotegal.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
