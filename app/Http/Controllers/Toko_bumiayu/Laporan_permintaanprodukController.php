...
public function index(Request $request)
{
    ...
    return view('toko_banjaran.laporan_permintaanproduk.index', compact('inquery', 'produks', 'tokos', 'klasifikasis', 'klasifikasi_id'));
}
...
public function indexrinci(Request $request)
{
    ...
    return view('toko_banjaran.laporan_permintaanproduk.indexrinci', compact('inquery', 'produks', 'tokos', 'klasifikasis', 'klasifikasi_id'));
}
...
public function printReport(Request $request)
{
    ...
    $pdf = FacadePdf::loadView('toko_banjaran.laporan_permintaanproduk.print', compact('permintaanProduk', 'tokoData', 'klasifikasi_id', 'tanggal_permintaan', 'tanggal_akhir', 'filteredKlasifikasi'));
...
public function printReportRinci(Request $request)
{
    ...
    $pdf = FacadePdf::loadView('toko_banjaran.laporan_permintaanproduk.printrinci', compact('permintaanProduk', 'produkByTokoAndDivisi', 'tokoData', 'klasifikasi_id', 'tanggal_permintaan', 'tanggal_akhir'));
    return $pdf->stream('laporan_permintaan_produk.pdf');
}
