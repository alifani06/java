...
class Laporan_setoranpenjualanbmyController extends Controller
{
    ...
    public function index(Request $request)
{
    ...
    if ($kasir) {
        ...
        $queryPenjualanKotor->where('toko_id', 5);
    }
    ...
    $metodePembayaran = function($metode_id, $tanggal_penjualan = null, $tanggal_akhir = null) use ($kasir) {
        ...
        if ($kasir) {
            ...
            $queryPenjualan->where('toko_id', 5);
        }
    ...
    public function printReportsetoranbmy(Request $request)
    {
        $status = $request->status;
        $tanggal_penjualan = $request->tanggal_penjualan;
        $tanggal_akhir = $request->tanggal_akhir;
        ...
        if ($kasir) {
            ...
            // Jika tidak memilih kasir, maka ambil data dengan toko_id = 1
            $penjualan_kotor->where('toko_id', 5);
        }
