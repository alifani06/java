...
class Laporan_returbumiayuController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('toko_bumiayu.laporan_returbumiayu.index', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'totalJumlah', 'grandTotal'));
    }
