...
class Inquery_penjualanprodukbumiayuController extends Controller
{
    ...
    //     $inquery = Penjualanproduk::query() ->where('toko_id', 5);;
    ...
    public function index(Request $request)
{
    ...
    $inquery = Penjualanproduk::with('metodePembayaran')->where('toko_id', 5);
    ...
    return view('toko_bumiayu.inquery_penjualanproduk.index', compact('inquery', 'metodes'));
}
    ...
    public function edit($id)
    {
        ...
        return view('toko_bumiayu.inquery_penjualanproduk.update', compact('penjualan','produks','metodes'));
    }
        ...
        public function update(Request $request, $id)
        {
            ...
            return redirect()->route('inquery_penjualanprodukbumiayu.index')->with('success', 'Data penjualan berhasil diperbarui.');
        }
