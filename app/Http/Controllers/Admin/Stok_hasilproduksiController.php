...
class Stok_hasilproduksiController extends Controller{
    public function index()
    {
        $today = Carbon::now('Asia/Jakarta')->toDateString();
    
        // Ambil stok barang jadi beserta informasi produk terkait
        $stokBarangJadi = Stokhasilproduksi::with('produk')->get();
    
        return view('admin.stok_hasilproduksi.index', compact('stokBarangJadi'));
    }
