...
class Laporan_hasilpenjualanController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        // Kirim data ke view
        return view('admin.laporan_hasilpenjualan.index', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'produks'));
    }

    public function barangMasukpesanan(Request $request)
    {
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        $tanggal_akhir = $request->tanggal_akhir;
        ...
        // Kirim data ke view
        return view('admin.laporan_hasilpenjualan.barangmasukpesanan', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'produks'));
    }

    public function barangMasuksemua(Request $request)
    {
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        $tanggal_akhir = $request->tanggal_akhir;
        ...
        // Kirim data ke view
        return view('admin.laporan_hasilpenjualan.barangmasuksemua', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'produks'));
    }
    ...
    public function barangKeluar(Request $request)
    {
        ...
        if (!$status && !$tanggal_penjualan && !$tanggal_akhir && !$toko_id && !$klasifikasi_id && !$produk_id) {
            // Jika tidak ada filter, kirim data kosong ke view
    ...
    public function barangOperantoko(Request $request)
    {
        $status = $request->status;
        ...
        return view('admin.laporan_hasilpenjualan.barangoperan', compact('stokBarangJadi', 'tokos', 'klasifikasis', 'totalJumlah', 'grandTotal'));
    }
    ...
    public function printLaporanBmpesanan(Request $request)
    {
        // Ambil parameter filter dari request
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        ...
        // Memuat konten HTML dari view
        $pdf = FacadePdf::loadView('admin.laporan_hasilpenjualan.printbmpesanan', [
            'groupedData' => $groupedData,
            'startDate' => $formattedStartDate,
            'endDate' => $formattedEndDate,
            'branchName' => $branchName,
    ...
    public function printLaporanBmsemua(Request $request)
    {
        // Ambil parameter filter dari request
        $status = $request->status;
        $tanggal_pengiriman = $request->tanggal_pengiriman;
        ...
        // Memuat konten HTML dari view
        $pdf = FacadePdf::loadView('admin.laporan_hasilpenjualan.printbmsemua', [
            'groupedData' => $groupedData,
            'startDate' => $formattedStartDate,
            'endDate' => $formattedEndDate,
            'branchName' => $branchName,
