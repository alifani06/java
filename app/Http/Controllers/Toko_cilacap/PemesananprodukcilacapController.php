...
class PemesananprodukcilacapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $inquery = Pemesananproduk::with('dppemesanan') // Memuat relasi dppemesanan
            ->where('toko_id', 6) // Hanya tampilkan data dengan toko_id = 1
        ...
        // Kirim data ke view
        return view('toko_cilacap.pemesanan_produk.index', compact('inquery'));
    }
    ...
    public function create(Request $request)
    {
        ...
        $produks = Produk::with(['tokocilacap', 'stokpesanan_tokocilacap'])->get();

        $kategoriPelanggan = 'member';
    
        return view('toko_cilacap.pemesanan_produk.create', compact('barangs','metodes', 
    ...
    public function cetak($id)
    {
        ...
        return view('toko_cilacap.pemesanan_produk.cetak', compact('pemesanan', 'pelanggans', 'tokos', 'dp'));
    }
    ...
    public function cetakPdf($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_cilacap.pemesanan_produk.cetak-pdf', compact('pemesanan', 'tokos', 'pelanggans','dp'));
    ...
    public function edit($id)
    {
        ...
        return view('toko_cilacap.pemesanan_produk.update', compact('inquery', 'tokos', 'pelanggans', 'tokoslawis', 'produks', 'selectedTokoId', 'metodes'));
    }
