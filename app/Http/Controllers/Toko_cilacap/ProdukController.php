...
class ProdukController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('toko_cilacap.produk.index', compact('produks', 'search', 'klasifikasis','subklasifikasis'));
    }
    ...
    public function create()
    {
        ...
        $subs1 = Subsub::all();
        return view('toko_cilacap/produk.create', compact('produks', 'klasifikasis', 'subs', 'subs1'));
    }
 ...
 
    {
        ...
        return redirect('toko_cilacap/produk')->with('success', 'Berhasil menambahkan produk');
    }
    ...
    public function edit($id)
    {
        ...
        return view('toko_cilacap/produk.update', compact('produk'));  
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect('toko_cilacap/produk')->with('success', 'Berhasil mengubah produk');
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect('toko_cilacap/produk')->with('success', 'Berhasil menghapus data produk');
    }
