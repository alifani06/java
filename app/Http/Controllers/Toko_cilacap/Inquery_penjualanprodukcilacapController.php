...
class Inquery_penjualanprodukcilacapController extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('toko_cilacap.inquery_penjualanproduk.update', compact('penjualan','produks','metodes'));
    }
        ...
        public function update(Request $request, $id)
        {
            ...
            return redirect()->route('inquery_penjualanprodukcilacap.index')->with('success', 'Data penjualan berhasil diperbarui.');
        }
        ...
        public function destroy($id)
        {
            try {
                ...
                return redirect()->route('toko_cilacap.inquery_penjualanproduk.index')
