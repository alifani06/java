...
class Inquery_pengirimanbarangjadiController extends Controller{
    ...
    public function index(Request $request)
    {
            ...
            return view('toko_tegal.inquery_pengirimanbarangjadi.index', compact('stokBarangJadi'));
    }
    ...
    public function show($id)
    {
        ...
        return view('toko_tegal.inquery_pengirimanbarangjadi.show', compact('pengirimanBarangJadi', 'firstItem'));
    }
