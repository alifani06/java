...
class PenjualanprodukcilacapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('toko_cilacap.penjualan_produk.index', compact('inquery'));
    }
    ...
    //     return view('toko_cilacap.penjualan_produk.create', compact('search','barangs', 'tokos', 'produks', 'details', 'tokoslawis', 'pelanggans', 'kategoriPelanggan','dppemesanans','pemesananproduks','metodes'));
    // }
        ...
        public function create()
        {
            ...
            $produks = Produk::with(['tokocilacap', 'stok_tokocilacap'])->get();
    
            $kategoriPelanggan = 'member';
            
            return view('toko_cilacap.penjualan_produk.create', compact('barangs', 'tokos', 'produks', 'details', 'pelanggans', 'kategoriPelanggan','dppemesanans','pemesananproduks','metodes'));
        }
        //store lama
    public function store(Request $request)
    {
        ...
        foreach ($data_pembelians as $data_pesanan) {
            ...
            $stok = Stok_tokocilacap::where('produk_id', $data_pesanan['produk_id'])->first();
            if ($stok) {
        ...
        $pdfUrl = route('toko_cilacap.penjualan_produk.cetak-pdf', ['id' => $cetakpdf->id]);
    ...
    public function pelunasan()
    {
        ...
        return view('toko_cilacap.penjualan_produk.pelunasan', compact('barangs','metodes', 'tokos', 'produks', 'details', 'tokoslawis', 'tokobanjarans', 'pelanggans', 'kategoriPelanggan', 'dppemesanans', 'pemesananproduks'));
    }
    ...
    public function SimpanPelunasan(Request $request)
    {
        ...
        // Kirimkan URL untuk tab baru
        $pdfUrl = route('toko_cilacap.pelunasan_pemesanan.cetak-pdf', ['id' => $pelunasan->id]);
    ...
    public function kode()
{
    ...
    public function cetak($id)
    {
        ...
        return view('toko_cilacap.penjualan_produk.cetak', compact('penjualan', 'pelanggans', 'tokos'));
    }
    ...
    public function cetakPdf($id)
    {
        ...
        $pdf = FacadePdf::loadView('toko_cilacap.penjualan_produk.cetak-pdf', compact('penjualan', 'tokos', 'pelanggans'));
