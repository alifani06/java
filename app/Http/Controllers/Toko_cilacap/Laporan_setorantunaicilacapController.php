...
class Laporan_setorantunaicilacapController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $setoranPenjualans = Setoran_penjualan::where('toko_id', 6) // Filter berdasarkan toko_id = 2
        ...
        // Kirim data ke view
        return view('toko_cilacap.laporan_setorantunai.index', compact('setoranPenjualans'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('toko_cilacap.setoran_tokotegal.create', compact(
            'produks',
            'tokos',
            'klasifikasis',
            'kasirs',
