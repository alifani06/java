...
class Inquery_returcilacapController extends Controller{
    ...
    public function index(Request $request)
    {
            ...
            return view('toko_cilacap.inquery_returcilacap.index', compact('stokBarangJadi'));
    }
...
public function create()
{
    ...
    return view('toko_cilacap.retur_tokocilacap.create', compact('produks', 'tokos'));
}
...
public function show($id)
{
    ...
    return view('toko_cilacap.inquery_returslawi.show', compact('pengirimanBarangJadi', 'firstItem'));
}
