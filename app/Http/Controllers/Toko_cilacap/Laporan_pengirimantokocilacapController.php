...
class Laporan_pengirimantokocilacapController extends Controller
{
    ...
    public function index(Request $request)
    {
            ...
            $query = Pengiriman_tokocilacap::with('produk.klasifikasi');
            ...
            return view('toko_cilacap.laporan_pengirimantokocilacap.index', compact('stokBarangJadi'));
    }
    ...
    public function printReport(Request $request)
{
    ...
    $query = Pengiriman_tokocilacap::query();
    ...
    $html = view('toko_cilacap.laporan_pengirimantokocilacap.print', [
