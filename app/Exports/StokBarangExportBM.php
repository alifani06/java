...
use Carbon\Carbon;
    ...
    class StokBarangExportBM implements FromCollection, WithHeadings, WithMapping, WithTitle, WithCustomStartCell
    {
        protected $request;
        protected $counter;
        ...
        {
            return [
                ['LAPORAN BARANG MASUK'], // Judul di baris pertama
                [], // Kosongkan baris kedua
                ['No', 'Tanggal Pengiriman', 'Kode Produk', 'Nama Produk', 'Harga', 'Jumlah', 'Total'] // Header tabel
            ];
        }
        ...
        {
            return 'Laporan Barang Masuk'; // Nama sheet
        }
