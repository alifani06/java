...
class StokBarangExportBMpesananSlawi implements FromCollection, WithHeadings, WithMapping, WithTitle, WithCustomStartCell, ShouldAutoSize
{
    protected $request;
    protected $counter;
    ...
    public function collection()
    {
        ...
        $toko_id = 3;  // Set toko_id = 1 secara langsung
